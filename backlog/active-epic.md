...
| **2 — components** | Confirmation hierarchy merge + button-order fixes (G6/G7) · detail-card builder + retrofit ×6 (G5) · modal adoption ×9 per-site-fit (G4) + modal form toolkit (D15: right-input-per-type, Label descriptions, preserve-input-on-failure) · browse list-embed/filter-row builders (G9) + list grammar (§2.4) + empty-state CTAs (D19) · dashboard pagination-by-concern (D14: defaults dashboard 3 pages) · Close-button removal (D18 — precondition satisfied) · post-action button-preservation criterion · `/inspect` disposition pass (spec §6) · Components-V2 pilot on character view (D17) | **SLICES COMPLETE 2026-07-19** — pilot ✅ (#1703) · browse builders + retrofit 17/17 ✅ (#1700/#1707/#1709/#1710) · confirmation+router ✅ (#1697/#1698) · alias tiers ✅ (#1701/#1702) · modal wave ✅ COMPLETE (#1711/#1714/#1716/#1718 — zero hand-rolled sites) · D18 ✅ (#1717) · detail-card builder ✅ (#1719 — 6 sites; character/view declined per the 2-callback ceiling) · router migration + D14 ✅ (#1720 — settings no-ack fixed; max 5 sections, threshold documented) · D16 context menu ✅ (#1724) · `/inspect` residual ✅ (#1724/#1725) · V2 pilot ✅ (#1726 — kill switch live) · **Close-out before declaring the phase DONE: owner V2 pilot eval (mobile-first, council protocol) + verify the post-action button-preservation criterion against the shipped #1721/#1722 behavior** |
