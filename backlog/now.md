...
- **Waiting on**:
  1. **The TASK-1039 read:** the diary thread, OFF 09-22 against ON 09-23, with the 09-24 thread excluded. It decides doc-97 Phase 4 slice 2 (the measured default for N, the override cascade, the facts-vocabulary slice).
