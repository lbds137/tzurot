...
- **Waiting on**: doc-77 PR C (config-time validation — probe-measured cases recorded in doc-77: `off` 400s on reasoning-mandatory OpenRouter models, `off` is best-effort on GLM-5.x).
