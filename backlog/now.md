...
- **In**: #2451 — TASK-1013 (daily stale-digest retention sweep) + TASK-1014 (digests in the account export, `formatVersion` 3); ai-worker runtime; the cut criterion is met.
