...
- **Deploy notes**: owner dev smoke for PR B when convenient — one message on a GLM preset via BYOK, `/inspect` should show the canonical level and the trace; not gating.
