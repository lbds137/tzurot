/**
 * Stryker mutation-testing config — identity (suite-wide rollout of the
...
export default {
  ...
  htmlReporter: { fileName: '../../reports/mutation/identity/index.html' },
  jsonReporter: { fileName: '../../reports/mutation/identity/mutation.json' },
