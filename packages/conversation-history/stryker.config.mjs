/**
 * Stryker mutation-testing config — conversation-history (suite-wide rollout of
 * the config-resolver pilot; see that package for the original rationale).
 *
...
export default {
  ...
  htmlReporter: { fileName: '../../reports/mutation/conversation-history/index.html' },
  jsonReporter: { fileName: '../../reports/mutation/conversation-history/mutation.json' },
