/**
 * Stryker mutation-testing config — cache-invalidation (suite-wide rollout of
...
export default {
  ...
  htmlReporter: { fileName: '../../reports/mutation/cache-invalidation/index.html' },
  jsonReporter: { fileName: '../../reports/mutation/cache-invalidation/mutation.json' },
