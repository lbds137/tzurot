...
export const BUILDER_IMPORT_ALLOWLIST: Readonly<Record<string, readonly string[]>> = {
  ...
  'services/bot-client/src/commands/preset/default/clear.ts': ['EmbedBuilder'],
  'services/bot-client/src/commands/preset/default/set.ts': ['EmbedBuilder'],
  ...
  'services/bot-client/src/commands/voice/tts/default.ts': ['EmbedBuilder'],
