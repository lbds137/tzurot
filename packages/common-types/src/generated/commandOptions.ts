 ...
 * Generated at: 2026-05-03T13:06:51.848Z
 *
...
/**
 * /settings tts set <personality, tts>
 */
export const settingsTtsSetOptions = defineTypedOptions({
  personality: { type: 'string', required: true },
  tts: { type: 'string', required: true },
});

/**
 * /settings tts reset <personality>
 */
export const settingsTtsResetOptions = defineTypedOptions({
  personality: { type: 'string', required: true },
});

/**
 * /settings tts default <tts>
 */
export const settingsTtsDefaultOptions = defineTypedOptions({
  tts: { type: 'string', required: true },
});

/**
 * /settings voices delete <voice>
 */
export const settingsVoicesDeleteOptions = defineTypedOptions({
  voice: { type: 'string', required: true },
});

/**
 * /settings voices model <model>
 */
export const settingsVoicesModelOptions = defineTypedOptions({
