...
describe('BlacklistService', () => {
  ...
  describe('blacklistUser', () => {
    ...
    it('should throw error if user is already blacklisted', async () => {
      const userId = '123456789';
      const existingUser = new BlacklistedUser(userId, 'Previous reason', '111111111', new Date());
    ...
    it('should handle repository errors', async () => {
      ...
      await expect(blacklistService.blacklistUser(userId, 'Reason', '987654321')).rejects.toThrow(
        'Database error'
      );
  ...
  describe('unblacklistUser', () => {
    ...
    it('should throw error if user is not blacklisted', async () => {
      ...
      await expect(blacklistService.unblacklistUser(userId, '987654321')).rejects.toThrow(
    ...
    it('should handle repository errors', async () => {
      const userId = '123456789';
      const blacklistedUser = new BlacklistedUser(userId, 'Reason', '111111111', new Date());
  ...
  describe('isUserBlacklisted', () => {
    ...
    it('should handle repository errors', async () => {
      ...
      await expect(blacklistService.isUserBlacklisted('123456789')).rejects.toThrow(
        'Database error'
      );
    });
  });
  ...
  describe('getBlacklistedUsers', () => {
    ...
    it('should handle repository errors', async () => {
      ...
      await expect(blacklistService.getBlacklistedUsers()).rejects.toThrow('Database error');
    });
  });

  describe('getBlacklistDetails', () => {
    it('should return blacklist details for a user', async () => {
      const blacklistedUser = new BlacklistedUser('123456789', 'Spamming', '987654321', new Date());
    ...
    it('should handle repository errors', async () => {
      ...
      await expect(blacklistService.getBlacklistDetails('123456789')).rejects.toThrow(
        'Database error'
      );
    });
  });
