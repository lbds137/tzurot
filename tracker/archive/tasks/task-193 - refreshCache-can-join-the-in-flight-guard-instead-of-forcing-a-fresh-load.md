...
---
Pass 2026-09-04 (TASK-888 half 1), owner ruling: ARCHIVED. obsolete: refreshCache() was replaced by refreshFromSource() (586a1845b), which overwrites with setex and never deletes the key first, so the stale-key window cannot occur.
---
<!-- COMMENTS:END -->
