...
**DECIDED 2026-08-14 (owner, TASK-599 digest): disclosure only (option a) - one line in the privacy policy erasure section + the delete-warning embed, riding the legal finalization pass. Widening the sweep ruled out (false-positive stakes on other users data).**
