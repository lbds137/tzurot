...
Owner question: should a spoilered plain attachment be labeled the same way as embed media (recommended, for parity with the ruling on embeds), or left unlabeled?
Recommendation: label it — the same ruling applies, a human can click to unmask either kind.
