...
<!-- SECTION:NOTES:BEGIN -->
Rewritten 2026-07-28 against current code: post-parse __includeRawResponse + extractAndPopulateOpenRouterReasoning mechanism, z.ai non-bridge, 400-recovery, empty-content promotion, GLM echo pattern, understanding tag, reasoningDebug fields. Direct develop docs commit.
<!-- SECTION:NOTES:END -->
