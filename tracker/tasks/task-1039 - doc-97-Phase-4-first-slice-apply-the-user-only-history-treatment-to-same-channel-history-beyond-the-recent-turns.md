...
created: 2026-09-25 15:11
---
SECOND READ 2026-09-25 (dev memories for the register, prod ai-worker logs of the previous deployment fa3baf75 for engagement; the prod DB read was classifier-blocked, so the diagnostic-row count is missing). Thread: 1552664578100428841 (09-24, Emily only; Lilith did not chat that day). Engagement CONFIRMED: 14 Same-channel history rendered lines, mode summarized, verbatimExchanges capped at 3 from the 4th turn (13:50Z, 09:50 EDT, earlier than the ~12:08 EDT recorded above), summarized climbing 1..10 by the 14th turn, fallbackVerbatim 0. Register (avg assistant chars / excl per 1k): 09-22 OFF thread 14 turns 874 / 0.25; 09-24 turns 1-3 (N not yet binding) 942 / 0.53; 09-24 turns 4-13 (N=3, summaries in the prompt) 9 turns 1186 / 0.00. Fresh-thread baseline 241 / 4.1. The mode fully engaged moved nothing toward the card register (longer, fewer exclamations, noise level), consistent with the 09-24 observation that fresh threads open in the long register from turn 1. DECIDES: slice 2 (measured default N, override cascade) is NOT in beta.231; the train is a drain train. Owner question (recommendation: set sameChannelVerbatimExchanges back to 10 on Emily and Lilith; N=3 buys nothing and drops seven verbatim exchanges of continuity; the mode itself may stay on). Untested candidates for what sets the register remain the ones listed on 09-24: diary-entry length, retrieved memories, the card.
---
