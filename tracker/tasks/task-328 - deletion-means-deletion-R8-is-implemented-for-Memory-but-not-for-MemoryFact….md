...
<!-- SECTION:NOTES:BEGIN -->
Shipped as PR #1826 (merged 2026-07-28): propagateDeletionToFacts cascade at all four memory soft-delete sites + data-only backfill migration. Owner calls: any-source retirement, locked+corrected carve-outs, revival on fresh evidence (forgotten stays terminal). Escalation for the join cost filed as TASK-340.
<!-- SECTION:NOTES:END -->
