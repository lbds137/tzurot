...
Scheduled by the 2026-09-09 mining run (proposal R9): ride the NEXT main-cut PR. Nine silent completions across two windows since filing; detection works every time, only the fix is missing, and it keeps slipping because it cannot land develop-first.
