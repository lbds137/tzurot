...
<!-- SECTION:NOTES:BEGIN -->
Verified shipped 2026-07-28: handleEditButton + handleEditTruncatedButton route acks through ackWithTimeoutCatch/showModalWithTimeoutCatch (the 04-discord sanctioned wrapper for fetch-before-modal), handleEditModalSubmit acks first via ackUpdate. Enforced by the @tzurot/component-handler-ack-first ESLint rule at error level.
<!-- SECTION:NOTES:END -->
