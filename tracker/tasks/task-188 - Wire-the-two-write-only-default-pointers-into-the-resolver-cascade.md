...
**DECIDED 2026-08-14 (owner, TASK-599 digest): build the two resolver read tiers standalone (globalDefaultLlmConfig in LlmConfigResolver, freeDefaultVisionConfig in VisionConfigResolver) + surface the occupied slot in the delete-guard 400.**
