...
Owner ruling 2026-09-13 evening: NO manual rotation first — this command IS the rotation; its first prod run rotates INTERNAL_SERVICE_SECRET. The open window until it ships (the value in one session transcript and in pre-beta.224 gateway log lines under Railway retention) is accepted by the owner. Sequencing: TASK-62 follow-up then this, at the head of the beta.225 Opus lane. Priority raised to high on that ruling.
