...
- ✨ `[FEAT]` **Config cascade extension — server and user-server tiers** — Add server-level tiers so server admins can set defaults. Significant refactor. Related to Model Configuration Overhaul theme.
