...
- **Gemini 3.1 Flash TTS** (Google, 2026-04-15) — 70+ languages, Elo 1,211 on Artificial Analysis TTS leaderboard, "Audio Profiles" via natural-language Director's Notes, SynthID watermarking. **Open questions**: pricing not disclosed (preview), whether "Audio Profiles" includes true zero-shot cloning or preset-voice selection only, latency, API stability.
