...
3. **Small (<~2hr), independent, and you'll actually do it soon?** → `now.md` › ⚡ Quick Wins (max 5) — no trigger needed, it's simply next in line
4. **Small, one sentence, waiting on an _observable_ trigger?** → `cold/follow-ups.md` (table row)
