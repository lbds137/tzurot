    ...
    it('should set configOverrides when cascadeResolver is present', async () => {
      ...
      const mockOverrides = {
        ...
        sources: {
          ...
          crossChannelRenderMode: 'hardcoded' as const,
          crossChannelMaxMessages: 'hardcoded' as const,
          sameChannelRenderMode: 'hardcoded' as const,
          sameChannelVerbatimExchanges: 'hardcoded' as const,
