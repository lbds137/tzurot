...
} from './diagnostics/DiagnosticDefaults.js';

// Re-export types for backward compatibility
export type { DiagnosticCollectorOptions } from './diagnostics/DiagnosticTypes.js';
...
export class DiagnosticCollector {
  ...
  finalize(): DiagnosticPayload {
    ...
    const payload: DiagnosticPayload = {
      meta: this.meta,
      inputProcessing: this.inputProcessing ?? getDefaultInputProcessing(),
      memoryRetrieval: this.memoryRetrieval ?? getDefaultMemoryRetrieval(),
      tokenBudget: this.tokenBudget ?? getDefaultTokenBudget(),
      assembledPrompt: this.assembledPrompt ?? getDefaultAssembledPrompt(),
      llmConfig: this.llmConfig ?? getDefaultLlmConfig(),
      llmResponse: this.llmResponse ?? getDefaultLlmResponse(),
      postProcessing: this.postProcessing ?? getDefaultPostProcessing(),
      timing,
    };
