 ...
 * Used both by handleContext (dashboard init) and createSettingsCommandHandlers
...
const channelContextHandlers = createSettingsCommandHandlers({
  entityType: ENTITY_TYPE,
  settingsConfig: CHANNEL_CONTEXT_CONFIG,
  createUpdateHandler,
});

export const handleChannelContextSelectMenu = channelContextHandlers.handleSelectMenu;
export const handleChannelContextButton = channelContextHandlers.handleButton;
export const handleChannelContextModal = channelContextHandlers.handleModal;
export const isChannelContextInteraction = channelContextHandlers.isInteraction;
