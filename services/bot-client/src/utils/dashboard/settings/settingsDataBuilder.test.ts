...
describe('buildCascadeSettingsData', () => {
  it('should use resolved values and sources when resolved data is provided', () => {
    const resolved: ResolvedConfigOverrides = {
      ...
      crossChannelRenderMode: 'both' as const,
      crossChannelMaxMessages: null,
      sameChannelRenderMode: 'both' as const,
      ...
      sources: {
        ...
        crossChannelRenderMode: 'hardcoded',
        crossChannelMaxMessages: 'hardcoded',
        sameChannelRenderMode: 'hardcoded',
        sameChannelVerbatimExchanges: 'hardcoded',
  ...
  it('should include all 15 config fields', () => {
    const result = buildCascadeSettingsData(null, null, 'admin');
