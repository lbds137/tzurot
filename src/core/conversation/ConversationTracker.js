...
class ConversationTracker {
  ...
  getConversationByMessageId(messageId) {
    ...
    if (data) {
      logger.debug(`[ConversationTracker] Found personality ${data.personalityName} for message ${messageId}`);
      return data;
    }
  ...
  loadFromData(conversations, messageMappings) {
    ...
    if (conversations) {
      ...
      logger.info(`[ConversationTracker] Loaded ${this.activeConversations.size} active conversations`);
    }
