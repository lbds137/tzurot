...
> **Quick Navigation**: 13 project-specific Claude Code Skills that codify Tzurot v3 development best practices.
...
| [tzurot-gemini-collab](./tzurot-gemini-collab/SKILL.md) | Design   | Consulting Gemini MCP               |
...
| Stuck on problem         | tzurot-gemini-collab |
