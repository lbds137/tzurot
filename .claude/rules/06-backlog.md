...
| Small (<~2hr), independent — and you'll actually do it soon | `now.md` › ⚡ Quick Wins (max 5) — no trigger needed; it's next |
| Small, one sentence, waiting on an **observable** trigger   | `cold/follow-ups.md` (table row)                                |
