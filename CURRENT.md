...
3. **Wave 1 COMPLETE (2026-08-23 evening, dispatch-only posture)**: ~~750~~ #2197 · ~~736~~ #2198 · ~~43~~ #2199 · ~~737~~ #2200 · ~~738~~ #2201 — all merged. **NEXT — remaining train**: TASK-754 (assistant-turn timestamps, owner-confirmed; spec next) · TASK-639 · TASK-713 · TASK-616 · doc-12 P0.1+P0.2 (+privacy-policy rider; four owner Qs at build time). Filed today: 749 (adapters) · 751 (dead-image churn, owner) · 752 (usage-audit skill) · 753 (merge-gate compound gap) · 755 (triage-view markdown de-emphasis). Budget posture: Fable dispatch-only, calibration ~450M in-equiv/week in user_fable_plan_mechanics memory.
