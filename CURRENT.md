...
_None. PR #925 (PR #924 review polish — 3-commit bundle: tryResolveUserKey invariant test + AuthStep ProviderRouter constructor injection + VisionProcessor.test.ts redundant-overrides sweep) merged 2026-04-27 first-try LGTM (no review rounds). Plan-mode investigation discovered 4 of the 9 backlog items added during PR #924 work were already addressed inline during PR #921 review rounds 5-6 but never struck through — those have been cleaned up in `backlog/inbox.md`. Two real z.ai follow-ups remain: ZAI_VALIDATION_MODEL hardcoding (needs decision/research) and 402 verification (needs real probe). **Next**: end-to-end manual verification of z.ai on dev (Railway auto-deploys develop pushes) before any preset seeding work._
