...
- **Test Suites**: 254 total (254 passed, 0 failed)
- **Tests**: 4283+ passed, 0 failed (4283+ total)
- **Time**: <30s (optimized with fake timers and enhanced test infrastructure)
...
**Latest Coverage (v2.0.0 Release):**
- **Statements**: 85.77%
- **Branches**: 77.01%
- **Functions**: 85.34%
- **Lines**: 86.01%
...
-----------------------------------------|---------|----------|---------|---------|-------------------------------------------------------------------------------------------------------------------------------------------------------
All files                                |   85.77 |    77.01 |   85.34 |   86.01 |                                                                                                                                                             
