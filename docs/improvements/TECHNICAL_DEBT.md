...
### Voice Transcription Synchronous Pattern

**Location**: `services/bot-client/src/services/VoiceTranscriptionService.ts:71`
...
- VoiceMessageProcessor needs transcript result to:
  ...
  - Decide whether to continue processor chain
