...
describe('MemoryConversationRepository', () => {
  ...
  beforeEach(() => {
    ...
    testConversation = Conversation.start(
      conversationId,
      initialMessage,
      testPersonalityId
    );
  ...
  describe('save', () => {
    ...
    it('should update indexes when saving', async () => {
      ...
      expect(repository._personalityIndex.get(testPersonalityId.toString()).has(testConversation.id.toString())).toBe(true);
    });
    ...
    it('should handle save errors', async () => {
      ...
      await expect(repository.save(testConversation)).rejects.toThrow('Failed to save conversation');
    });
  });
  ...
  describe('findById', () => {
    ...
    it('should handle errors', async () => {
      ...
      await expect(repository.findById(testConversation.id)).rejects.toThrow('Failed to find conversation');
    });
  });
  ...
  describe('findActiveByUser', () => {
    ...
    it('should handle errors', async () => {
      ...
      await expect(repository.findActiveByUser('user-456')).rejects.toThrow('Failed to find conversations by user');
    });
  });
  ...
  describe('findByMessageId', () => {
    ...
    it('should handle errors', async () => {
      ...
      await expect(repository.findByMessageId('msg-1')).rejects.toThrow('Failed to find conversation by message');
    });
  });
  ...
  describe('findByPersonality', () => {
    ...
    it('should find all conversations with personality', async () => {
      ...
      expect(conversations.every(c => c.activePersonalityId?.toString() === testPersonalityId.toString())).toBe(true);
    });
    ...
    it('should handle errors', async () => {
      ...
      await expect(repository.findByPersonality(testPersonalityId)).rejects.toThrow('Failed to find conversations by personality');
    });
  });
  ...
  describe('delete', () => {
    ...
    it('should handle errors', async () => {
      ...
      await expect(repository.delete(testConversation.id)).rejects.toThrow('Failed to delete conversation');
    });
  });
  ...
  describe('cleanupExpired', () => {
    ...
    it('should handle errors', async () => {
      ...
      await expect(repository.cleanupExpired(new Date())).rejects.toThrow('Failed to cleanup expired conversations');
    });
  });
