...
describe('webhookManager audio handling', () => {
  ...
  describe('sendWebhookMessage', () => {
    it('should process file domain audio URLs in the message content', async () => {
      ...
      const messageContent = 'Check out this audio: https://files.example.org/ha-shem-keev-ima-rxk-2025-05-18-16-48-24.mp3';
      
      const result = await webhookManager.sendWebhookMessage(mockChannel, messageContent, personality);
      ...
      expect(result.processedContent).toBe('Check out this audio: [Audio: ha-shem-keev-ima-rxk-2025-05-18-16-48-24.mp3]');
    ...
    it('should process generic audio URLs in the message content', async () => {
      ...
      const messageContent = 'Check out this audio: https://example.com/path/to/mysong.mp3?param=value';
