...
describe('Permissions Middleware', () => {
  ...
  it('should check ADMINISTRATOR permission correctly', () => {
    ...
    expect(validator.getPermissionErrorMessage).toHaveBeenCalledWith('ADMINISTRATOR', 'admin-command');
  ...
  it('should check MANAGE_MESSAGES permission correctly', () => {
    ...
    expect(validator.getPermissionErrorMessage).toHaveBeenCalledWith('MANAGE_MESSAGES', 'mod-command');
  ...
  it('should check NSFW_CHANNEL permission correctly', () => {
    ...
    expect(validator.getPermissionErrorMessage).toHaveBeenCalledWith('NSFW_CHANNEL', 'nsfw-command');
