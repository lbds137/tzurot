...
describe('Alias Command Handler', () => {
  ...
  test('should show error when personality is not found', async () => {
    ...
    expect(mockMessage.channel.send).toHaveBeenCalledWith(expect.stringContaining('not found'));
  });
  ...
  test('should handle errors from the setPersonalityAlias function', async () => {
    ...
    // Check that error message was sent
    expect(mockMessage.channel.send).toHaveBeenCalledWith('You cannot set this alias');
  });
