...
describe('Remove Command', () => {
  ...
  it('should remove a personality by alias', async () => {
    ...
    // Verify embed was created correctly
    expect(mockEmbed.setTitle).toHaveBeenCalledWith('Personality Removed');
    expect(mockEmbed.setDescription).toHaveBeenCalledWith(expect.stringContaining('Display Name'));
  ...
  it('should handle unexpected errors gracefully', async () => {
    ...
    const logger = require('../../../../src/logger');
    expect(logger.error).toHaveBeenCalledWith('Error in remove command:', testError);
