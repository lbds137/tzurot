...
describe('AuthPersistence', () => {
  ...
  describe('ensureDataDir', () => {
    ...
    it('should handle directory creation errors', async () => {
      ...
      expect(logger.error).toHaveBeenCalledWith(
        '[AuthPersistence] Failed to create data directory:',
        error
      );
    });
  });
  ...
  describe('loadUserTokens', () => {
    ...
    it('should return empty object when file does not exist', async () => {
      ...
      expect(logger.info).toHaveBeenCalledWith(
        '[AuthPersistence] No tokens file found, returning empty object'
      );
    });
  ...
  describe('saveUserTokens', () => {
    ...
    it('should handle write errors', async () => {
      ...
      expect(logger.error).toHaveBeenCalledWith(
        '[AuthPersistence] Error saving user tokens:',
        error
      );
    });
    ...
    it('should handle empty tokens object', async () => {
      ...
      expect(result).toBe(true);
      expect(fs.writeFile).toHaveBeenCalledWith('/test/data/auth_tokens.json', '{}');
    });
  });
  ...
  describe('loadNsfwVerifications', () => {
    ...
    it('should return empty object when file does not exist', async () => {
      ...
      expect(result).toEqual({});
      expect(logger.info).toHaveBeenCalledWith(
        '[AuthPersistence] No NSFW verification file found, returning empty object'
      );
    });
    ...
    it('should handle JSON parse errors', async () => {
      ...
      expect(result).toEqual({});
      expect(logger.error).toHaveBeenCalledWith(
        '[AuthPersistence] Error loading NSFW verifications:',
        expect.any(Error)
      );
    });
  });
  ...
  describe('saveNsfwVerifications', () => {
    ...
    it('should handle write errors', async () => {
      ...
      expect(result).toBe(false);
      expect(logger.error).toHaveBeenCalledWith(
        '[AuthPersistence] Error saving NSFW verifications:',
        error
      );
    });
  });
  ...
  describe('getFileStats', () => {
    it('should return file statistics', async () => {
      ...
      fs.stat.mockResolvedValueOnce(tokenStats).mockResolvedValueOnce(verificationStats);
  ...
  describe('createBackup', () => {
    it('should create backup of authentication data', async () => {
      ...
      fs.mkdir.mockResolvedValueOnce();
      fs.writeFile.mockResolvedValueOnce().mockResolvedValueOnce();

      const result = await persistence.createBackup();

      expect(fs.mkdir).toHaveBeenCalledWith('/test/data/backups', { recursive: true });
