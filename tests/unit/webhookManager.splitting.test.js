...
describe('WebhookManager - Message Splitting', () => {
  ...
  it('should split long message by paragraphs', () => {
    const longMessage = 'First paragraph with some text.\n\nSecond paragraph with more text.\n\nThird paragraph with additional text.';
  ...
  it('should split very long paragraphs by lines', () => {
    ...
    const longParagraph = 'This is the first line.\nThis is the second line that is very long and has lots of content. '.repeat(50);
  ...
  it('should split very long sentences by character limit at word boundaries', () => {
    ...
    const longSentence = 'Very long sentence with many words but no periods or other sentence breaks so it should be split by character limit at word boundaries '.repeat(50);
