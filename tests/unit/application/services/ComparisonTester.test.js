const { ComparisonTester, getComparisonTester, resetComparisonTester } = require('../../../../src/application/services/ComparisonTester');
...
describe('ComparisonTester', () => {
  ...
  describe('compare', () => {
    ...
    it('should throw on mismatch when configured', async () => {
      ...
      await expect(
        throwingTester.compare('test-operation', legacyOp, newOp)
      ).rejects.toThrow('Comparison mismatch');
    });
  });
