  ...
  describe('detectMedia', () => {
    ...
    describe('[Image: url] pattern detection', () => {
      ...
      it('should not detect image if audio already found', async () => {
        const mockMessage = createMockMessage();
        const content = '[Audio: https://example.com/audio.mp3] and [Image: https://example.com/image.jpg]';
    ...
    describe('Message attachments', () => {
      it('should detect audio attachment', async () => {
        ...
        expect(result.messageContent).toEqual([
          ...
          { type: 'audio_url', audio_url: { url: 'https://cdn.discord.com/attachments/123/456/audio.mp3' } }
        ]);
      });
    ...
    describe('Edge cases', () => {
      ...
      it('should skip warning when audio found before image (normal flow)', async () => {
        ...
        const result = await mediaHandler.detectMedia(mockMessage, 'Message with both media types', {});
      ...
      it('should handle malformed audio URL patterns', async () => {
        const mockMessage = createMockMessage();
        const content = '[Audio: not-a-url] and [Audio: ] and [Audio:https://example.com/audio.mp3]';
