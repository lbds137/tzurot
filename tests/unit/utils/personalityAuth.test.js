...
describe('Personality Authentication Module', () => {
  ...
  describe('checkPersonalityAuth', () => {
    ...
    it('should handle auth manager not initialized', async () => {
      ...
      await expect(personalityAuth.checkPersonalityAuth(mockMessage, mockPersonality))
    ...
    it('should handle validation errors gracefully', async () => {
      ...
      mockAuthManager.validatePersonalityAccess.mockRejectedValue(
  ...
  describe('requiresAuth', () => {
    it('should return true when personality requires auth', () => {
      ...
      expect(mockAuthManager.personalityAuthValidator.requiresAuth).toHaveBeenCalledWith(mockPersonality);
    });
  ...
  describe('requiresNsfwVerification', () => {
    it('should return true for NSFW channels', () => {
      ...
      expect(result).toBe(true);
      expect(mockAuthManager.nsfwVerificationManager.requiresNsfwVerification)
