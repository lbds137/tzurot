...
describe('auth', () => {
  beforeEach(async () => {
    ...
    const mockUserTokenManager = {
      ...
      getAuthorizationUrl: jest.fn().mockReturnValue('https://test.example.com/authorize?app_id=test-app-id'),
  ...
  describe('Core Authentication', () => {
    ...
    describe('exchangeCodeForToken', () => {
      ...
      test('should handle exchange errors', async () => {
        const mockAuthManager = AuthManager.mockInstance;
        mockAuthManager.userTokenManager.exchangeCodeForToken.mockRejectedValue(new Error('OAuth token exchange failed'));
        
        await expect(auth.exchangeCodeForToken('bad-code'))
