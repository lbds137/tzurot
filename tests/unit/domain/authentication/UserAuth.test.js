...
describe('UserAuth', () => {
  ...
  describe('refreshToken', () => {
    ...
    it('should reject if user blacklisted', () => {
      ...
      expect(() => userAuth.refreshToken(newToken)).toThrow('Cannot refresh token for blacklisted user');
    });
    ...
    it('should reject expired token', () => {
      ...
      expect(() => userAuth.refreshToken(expiredToken)).toThrow('Cannot refresh with expired token');
    });
  });
