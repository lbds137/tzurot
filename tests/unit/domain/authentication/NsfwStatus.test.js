...
describe('NsfwStatus', () => {
  ...
  describe('validation', () => {
    it('should require verification date when verified', () => {
      expect(() => new NsfwStatus(true, null)).toThrow('Verified status requires verification date');
    ...
    it('should not allow verification date without being verified', () => {
      expect(() => new NsfwStatus(false, new Date())).toThrow('Cannot have verification date without being verified');
    });
