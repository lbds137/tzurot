...
describe('ConversationId', () => {
  ...
  describe('constructor', () => {
    ...
    it('should require userId', () => {
      expect(() => new ConversationId(null, 'general')).toThrow('ConversationId requires valid userId');
      expect(() => new ConversationId('', 'general')).toThrow('ConversationId requires valid userId');
      expect(() => new ConversationId(undefined, 'general')).toThrow('ConversationId requires valid userId');
    });
    
    it('should require userId to be string', () => {
      expect(() => new ConversationId(123, 'general')).toThrow('ConversationId requires valid userId');
      expect(() => new ConversationId({}, 'general')).toThrow('ConversationId requires valid userId');
      expect(() => new ConversationId([], 'general')).toThrow('ConversationId requires valid userId');
    });
    
    it('should require channelId', () => {
      expect(() => new ConversationId('123456789012345678', null)).toThrow('ConversationId requires valid channelId');
      expect(() => new ConversationId('123456789012345678', '')).toThrow('ConversationId requires valid channelId');
      expect(() => new ConversationId('123456789012345678', undefined)).toThrow('ConversationId requires valid channelId');
    });
    
    it('should require channelId to be string', () => {
      expect(() => new ConversationId('123456789012345678', 123)).toThrow('ConversationId requires valid channelId');
      expect(() => new ConversationId('123456789012345678', {})).toThrow('ConversationId requires valid channelId');
      expect(() => new ConversationId('123456789012345678', [])).toThrow('ConversationId requires valid channelId');
    });
  });
  ...
  describe('fromString', () => {
    ...
    it('should throw for invalid format', () => {
      expect(() => ConversationId.fromString('invalidformat')).toThrow('Invalid conversation ID format');
      expect(() => ConversationId.fromString(':channelId')).toThrow('Invalid conversation ID format');
