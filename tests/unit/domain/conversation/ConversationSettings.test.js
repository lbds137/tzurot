...
describe('ConversationSettings', () => {
  ...
  describe('validation', () => {
    it('should validate autoResponseEnabled as boolean', () => {
      expect(() => new ConversationSettings({
        autoResponseEnabled: 'true',
  ...
  describe('withAutoResponseDelay', () => {
    ...
    it('should validate new delay', () => {
      ...
      expect(() => settings.withAutoResponseDelay(-1)).toThrow('autoResponseDelay must be non-negative number');
    });
  });
  ...
  describe('immutability', () => {
    it('should be immutable', () => {
      ...
      json.autoResponseDelay = 1000;
      json.mentionOnly = false;
      json.timeoutMs = 1000;
