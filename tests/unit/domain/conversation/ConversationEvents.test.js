...
describe('ConversationEvents', () => {
  ...
  describe('ConversationStarted', () => {
    ...
    it('should validate required fields', () => {
      expect(() => new ConversationStarted('123456789012345678:general', {}))
  ...
  describe('MessageAdded', () => {
    ...
    it('should validate required fields', () => {
      expect(() => new MessageAdded('123456789012345678:general', {}))
  ...
  describe('PersonalityAssigned', () => {
    ...
    it('should validate required fields', () => {
      expect(() => new PersonalityAssigned('123456789012345678:general', {}))
  ...
  describe('ConversationSettingsUpdated', () => {
    ...
    it('should validate required fields', () => {
      expect(() => new ConversationSettingsUpdated('123456789012345678:general', {}))
  ...
  describe('ConversationEnded', () => {
    ...
    it('should validate required fields', () => {
      expect(() => new ConversationEnded('123456789012345678:general', {}))
