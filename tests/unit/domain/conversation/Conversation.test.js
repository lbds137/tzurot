...
describe('Conversation', () => {
  ...
  describe('constructor', () => {
    it('should require ConversationId', () => {
      expect(() => new Conversation('string-id')).toThrow('Conversation must be created with ConversationId');
    });
  ...
  describe('start', () => {
    ...
    it('should validate ConversationId', () => {
      expect(() => Conversation.start('invalid', message, personalityId)).toThrow('Invalid ConversationId');
    });
    
    it('should validate Message', () => {
      expect(() => Conversation.start(conversationId, 'invalid', personalityId)).toThrow('Invalid initial message');
    });
    
    it('should validate PersonalityId', () => {
      expect(() => Conversation.start(conversationId, message, 'invalid')).toThrow('Invalid PersonalityId');
    });
  });
  ...
  describe('assignPersonality', () => {
    ...
    it('should reject if conversation ended', () => {
      ...
      expect(() => conversation.assignPersonality(newPersonalityId)).toThrow('Cannot assign personality to ended conversation');
    });
  });
  ...
  describe('updateSettings', () => {
    ...
    it('should reject if conversation ended', () => {
      ...
      expect(() => conversation.updateSettings(newSettings)).toThrow('Cannot update settings for ended conversation');
    });
  });
