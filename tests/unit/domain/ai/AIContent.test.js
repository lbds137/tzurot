...
describe('AIContent', () => {
  ...
  describe('constructor', () => {
    ...
    it('should validate items is array', () => {
      expect(() => new AIContent('not-an-array')).toThrow('AIContent must be initialized with an array');
    });
  ...
  describe('validateItem', () => {
    ...
    it('should reject text without text property', () => {
      expect(() => new AIContent([{ type: 'text' }])).toThrow('Text content must have text property');
    });
    
    it('should reject image without url', () => {
      expect(() => new AIContent([{ type: 'image_url' }])).toThrow('Image content must have image_url.url');
    });
    
    it('should reject audio without url', () => {
      expect(() => new AIContent([{ type: 'audio_url' }])).toThrow('Audio content must have audio_url.url');
    });
  });
