  ...
  describe('PersonalityCreated', () => {
    ...
    it('should reject missing personalityId', () => {
      ...
      expect(() => new PersonalityCreated('id', payload))
        .toThrow('PersonalityCreated requires personalityId, ownerId, and createdAt');
    });
  ...
  describe('PersonalityProfileUpdated', () => {
    ...
    it('should reject missing profile', () => {
      ...
      expect(() => new PersonalityProfileUpdated('id', payload))
        .toThrow('PersonalityProfileUpdated requires profile and updatedAt');
    });
  ...
  describe('PersonalityRemoved', () => {
    ...
    it('should reject missing removedBy', () => {
      ...
      expect(() => new PersonalityRemoved('id', payload))
        .toThrow('PersonalityRemoved requires removedBy and removedAt');
    });
  ...
  describe('PersonalityAliasAdded', () => {
    ...
    it('should reject missing alias', () => {
      ...
      expect(() => new PersonalityAliasAdded('id', payload))
        .toThrow('PersonalityAliasAdded requires alias, addedBy, and addedAt');
    });
  ...
  describe('PersonalityAliasRemoved', () => {
    ...
    it('should reject missing alias', () => {
      ...
      expect(() => new PersonalityAliasRemoved('id', payload))
        .toThrow('PersonalityAliasRemoved requires alias, removedBy, and removedAt');
    });
