...
const { PersonalityConfiguration } = require('../../../../src/domain/personality/PersonalityConfiguration');
...
describe('PersonalityConfiguration', () => {
  ...
  describe('constructor', () => {
    ...
    it('should reject missing name', () => {
      expect(() => new PersonalityConfiguration(
        null,
        'You are a helpful assistant',
        '/models/gpt-4'
  ...
  describe('fromJSON', () => {
    ...
    it('should apply validation when creating from JSON', () => {
      ...
      expect(() => PersonalityConfiguration.fromJSON(invalidJson))
        .toThrow('Name is required and must be a string');
    });
  });
