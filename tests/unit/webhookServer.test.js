...
const { createWebhookServer, verifyGitHubSignature, handleGitHubRelease } = require('../../src/webhookServer');
...
describe('webhookServer', () => {
  ...
  describe('verifyGitHubSignature', () => {
    it('should verify valid signature', () => {
      ...
      const signature = 'sha256=' + crypto.createHmac('sha256', testSecret)
        .update(payload)
        .digest('hex');
